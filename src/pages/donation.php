...
<div class="donation-poor bg-light p-5">
    <h4 class="text-uppercase text-center pb-3 mb-3">T'es pauvre ?</h4>

    <p class="mb-4 text-justify">Si vous ne possédez pas le moindre centime, vous pouvez participer vous-même en créant davantage de drama dans votre entourage, n'ayez pas peur de leur faire mal ou de leur causer du tort. Si vous hésitez, la fin de l'espèce humaine sera sur votre dos.</p>

    <div class="donation-give bg-light p-3 d-flex justify-content-center">
